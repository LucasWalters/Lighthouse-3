...
namespace Lighthouse3
{
    public class Material
    {
        ...
        public static Material Light = new Material(Color4.White, emissive: 1f);
        public static Material Glass = new Material(Color4.White, 0, 1, RefractiveIndex.Glass);
        public static Material Vacuum = new Material(Color4.White, 0, 1, RefractiveIndex.Vacuum);


        public Vector3 color;
        public float checkerboard;
        ...
        public Material(float r, float g, float b, float specularity = 0f, float transparency = 0f, float refractiveIndex = RefractiveIndex.Vacuum, float emissive = 0f, float glossiness = 0f) : 
            this(new Vector3(r, g, b), specularity, transparency, refractiveIndex, emissive, glossiness) { }

        public Material(Color4 color, float specularity = 0f, float transparency = 0f, float refractiveIndex = RefractiveIndex.Vacuum, float emissive = 0f, float glossiness = 0f) : 
            this(new Vector3(color.R, color.G, color.B), specularity, transparency, refractiveIndex, emissive, glossiness) { }

        public Material(Vector3 color, float specularity = 0f, float transparency = 0f, float refractiveIndex = RefractiveIndex.Vacuum, float emissive = 0f, float glossiness = 0f)
        {
            this.color = color;
