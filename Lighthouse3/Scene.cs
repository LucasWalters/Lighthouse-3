...
namespace Lighthouse3
{
    public class Scene
    {
        ...
        {
            Scene scene = new Scene();
            scene.mainCamera = new Camera(new Vector3(0, 0, -7), new Vector3(0, 0, 1), Game.SCREEN_WIDTH, Game.SCREEN_HEIGHT, 1.5f, 1);
            scene.backgroundColor = Color.Black;
            scene.lights = new Light[]
            {
                new PointLight(new Vector3(0, 3, 0), Color.White, 10)
                
                //new AreaLight(new Vector3(1,3,1), new Vector3(-1,3,1), new Vector3(1,3,-1),  Color.White, 10)
            };
            Material checkerboard = new Material(Color4.Gray);
            checkerboard.isCheckerboard = true;
            ...
            { 
				//new Sphere(new Vector3(4, 0, 7), 2),
				//new Sphere(new Vector3(-3, 3.5f, 8), 1.5f, red),
				new Plane(new Vector3(-3, 0, 0), new Vector3(1, 0, 0), Material.Blue),
                new Plane(new Vector3(0, 0, 3), new Vector3(0, 0, -1), checkerboard),
                new Plane(new Vector3(3, 0, 0), new Vector3(-1, 0, 0), Material.Red),
                new Plane(new Vector3(0, -2.9f, 0), new Vector3(0, 1, 0), Material.Green),
                //new Plane(new Vector3(0, 10, 0), new Vector3(0, -1, 0), Material.Yellow),


                new Sphere(new Vector3(0, 0, 0), 2f, Material.Yellow),
